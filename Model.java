...
// selceted list.
  ...
  public void setItemToMove(Item item) {
      itemToMove = item;
      view.refresh();
  }

  public void moveItem(Point itemPoint, Point newPoint) {
      if(itemToMove != null) {
          itemToMove.move(itemPoint, newPoint);
          itemToMove = null;
      }
      view.refresh();
  }
  ...
  public void setItemToRotate(Item item) {
      itemToRotate = item;
      view.refresh();
  }
  ...
  public void rotateItem(Point point) {
      if (itemToRotate != null) {
          itemToRotate.rotateCW(point);
          itemToRotate = null;
      }
      view.refresh();
  }

  public Item getItemToRotate() {
      return itemToRotate;
  }
}
